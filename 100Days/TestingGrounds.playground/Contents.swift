...
//For loop for a range(or use ..<x to go up to one less than the number) good for arrays
    for i in 1...12 {
        print("5 x \(i) is \(5 * i)")
    }
}
...
// create an integer to store our roll(Using .random())
var roll = 0
...
//Continue ends the iteration of a loop
